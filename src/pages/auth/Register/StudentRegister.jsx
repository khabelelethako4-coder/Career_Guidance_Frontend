// src/pages/Auth/Register/StudentRegister.jsx
...
const StudentRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await register(email, password, 'student', profile);
      setSuccess(true);
      ...
      >
        <div className="auth-success">
          ...
          <p className="success-message">
            Please check your inbox and click the link to activate your student account.
          </p>
